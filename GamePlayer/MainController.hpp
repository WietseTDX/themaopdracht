...
/// This class implements the GamePlayer logic
class MainController : public rtos::task<>, public KeyboardListener, public ButtonListener {
  ...
  hwlib::target::pin_out buzzer = hwlib::target::pin_out(hwlib::target::pins::d31);
  ...
  hwlib::target::pin_in button_pin = hwlib::target::pin_in(hwlib::target::pins::d29);
 ...
 public:
  ...
  /// translate Command
  /// \details
  /// It puts the StructData in the Channel <br> the id is by default 0 because with the keyboard he gets a id but with
  /// IrReceive not. <br> With 0 it will always pass thourt to the right state for the IRReciever
